...
public class Assimp {
  ...
  public static readonly string AI_CONFIG_IMPORT_NO_SKELETON_MESHES = AssimpPINVOKE.AI_CONFIG_IMPORT_NO_SKELETON_MESHES_get();
  ...
  public static readonly string AI_CONFIG_IMPORT_FBX_READ_ALL_GEOMETRY_LAYERS = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_READ_ALL_GEOMETRY_LAYERS_get();
  public static readonly string AI_CONFIG_IMPORT_FBX_READ_ALL_MATERIALS = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_READ_ALL_MATERIALS_get();
  public static readonly string AI_CONFIG_IMPORT_FBX_READ_MATERIALS = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_READ_MATERIALS_get();
  public static readonly string AI_CONFIG_IMPORT_FBX_READ_CAMERAS = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_READ_CAMERAS_get();
  public static readonly string AI_CONFIG_IMPORT_FBX_READ_LIGHTS = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_READ_LIGHTS_get();
  public static readonly string AI_CONFIG_IMPORT_FBX_READ_ANIMATIONS = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_READ_ANIMATIONS_get();
  public static readonly string AI_CONFIG_IMPORT_FBX_STRICT_MODE = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_STRICT_MODE_get();
  public static readonly string AI_CONFIG_IMPORT_FBX_PRESERVE_PIVOTS = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_PRESERVE_PIVOTS_get();
  public static readonly string AI_CONFIG_IMPORT_FBX_OPTIMIZE_EMPTY_ANIMATION_CURVES = AssimpPINVOKE.AI_CONFIG_IMPORT_FBX_OPTIMIZE_EMPTY_ANIMATION_CURVES_get();
  ...
  public static readonly string AI_CONFIG_IMPORT_COLLADA_IGNORE_UP_DIRECTION = AssimpPINVOKE.AI_CONFIG_IMPORT_COLLADA_IGNORE_UP_DIRECTION_get();
