...
public class aiNode : IDisposable {
  ...
  public aiMetadata mMetaData {
    set {
      AssimpPINVOKE.aiNode_mMetaData_set(swigCPtr, aiMetadata.getCPtr(value));
    } 
    get {
      IntPtr cPtr = AssimpPINVOKE.aiNode_mMetaData_get(swigCPtr);
      aiMetadata ret = (cPtr == IntPtr.Zero) ? null : new aiMetadata(cPtr, false);
      return ret;
    } 
  }
  ...
  public aiNode FindNode(string name) {
    IntPtr cPtr = AssimpPINVOKE.aiNode_FindNode__SWIG_2(swigCPtr, name);
    aiNode ret = (cPtr == IntPtr.Zero) ? null : new aiNode(cPtr, false);
    return ret;
  }
