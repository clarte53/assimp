...
class AssimpPINVOKE {
  ...
  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_NO_SKELETON_MESHES_get")]
  ...
  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_READ_ALL_GEOMETRY_LAYERS_get")]
  public static extern string AI_CONFIG_IMPORT_FBX_READ_ALL_GEOMETRY_LAYERS_get();

  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_READ_ALL_MATERIALS_get")]
  public static extern string AI_CONFIG_IMPORT_FBX_READ_ALL_MATERIALS_get();

  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_READ_MATERIALS_get")]
  public static extern string AI_CONFIG_IMPORT_FBX_READ_MATERIALS_get();

  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_READ_CAMERAS_get")]
  public static extern string AI_CONFIG_IMPORT_FBX_READ_CAMERAS_get();

  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_READ_LIGHTS_get")]
  public static extern string AI_CONFIG_IMPORT_FBX_READ_LIGHTS_get();

  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_READ_ANIMATIONS_get")]
  public static extern string AI_CONFIG_IMPORT_FBX_READ_ANIMATIONS_get();

  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_STRICT_MODE_get")]
  public static extern string AI_CONFIG_IMPORT_FBX_STRICT_MODE_get();

  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_PRESERVE_PIVOTS_get")]
  public static extern string AI_CONFIG_IMPORT_FBX_PRESERVE_PIVOTS_get();

  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_FBX_OPTIMIZE_EMPTY_ANIMATION_CURVES_get")]
  ...
  [DllImport("Assimp", EntryPoint="CSharp_AI_CONFIG_IMPORT_COLLADA_IGNORE_UP_DIRECTION_get")]
  ...
  [DllImport("Assimp", EntryPoint="CSharp_aiMetadata_mNumProperties_set")]
  public static extern void aiMetadata_mNumProperties_set(HandleRef jarg1, uint jarg2);

  [DllImport("Assimp", EntryPoint="CSharp_aiMetadata_mNumProperties_get")]
  public static extern uint aiMetadata_mNumProperties_get(HandleRef jarg1);

  [DllImport("Assimp", EntryPoint="CSharp_aiMetadata_mKeys_set")]
  public static extern void aiMetadata_mKeys_set(HandleRef jarg1, HandleRef jarg2);

  [DllImport("Assimp", EntryPoint="CSharp_aiMetadata_mKeys_get")]
  public static extern IntPtr aiMetadata_mKeys_get(HandleRef jarg1);

  [DllImport("Assimp", EntryPoint="CSharp_aiMetadata_mValues_set")]
  public static extern void aiMetadata_mValues_set(HandleRef jarg1, HandleRef jarg2);

  [DllImport("Assimp", EntryPoint="CSharp_aiMetadata_mValues_get")]
  public static extern IntPtr aiMetadata_mValues_get(HandleRef jarg1);

  [DllImport("Assimp", EntryPoint="CSharp_new_aiMetadata")]
  public static extern IntPtr new_aiMetadata();

  [DllImport("Assimp", EntryPoint="CSharp_delete_aiMetadata")]
  public static extern void delete_aiMetadata(HandleRef jarg1);

  [DllImport("Assimp", EntryPoint="CSharp_aiMetadata_Get")]
  public static extern bool aiMetadata_Get(HandleRef jarg1, HandleRef jarg2, HandleRef jarg3);
  ...
  [DllImport("Assimp", EntryPoint="CSharp_aiNode_mMetaData_set")]
  public static extern void aiNode_mMetaData_set(HandleRef jarg1, HandleRef jarg2);

  [DllImport("Assimp", EntryPoint="CSharp_aiNode_mMetaData_get")]
  public static extern IntPtr aiNode_mMetaData_get(HandleRef jarg1);
  ...
  [DllImport("Assimp", EntryPoint="CSharp_aiNode_FindNode__SWIG_2")]
  public static extern IntPtr aiNode_FindNode__SWIG_2(HandleRef jarg1, string jarg2);
